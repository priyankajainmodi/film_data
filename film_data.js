    ...
    fetch(`https://www.omdbapi.com/?t=${inp.value}&apikey=a5b97ecf`)
        ...
        .then((data) => {
            ...
            if (data.Response == 'False') {
                ...
                fetch(`https://imdb-api.com/en/API/SearchMovie/k_ismpibom/${inp.value}`)
                    .then(res => { console.log(res); return res.json(); })
                    .then((data) => { console.log(data); return data.results[0].id })
                    .then((title) => {

                        fetch(`https://imdb-api.com/en/API/YouTubeTrailer/k_ismpibom/${title}`)
                            .then((res) => { return res.json() })
                            .then((data) => {
